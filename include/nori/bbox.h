...
/* Added non member functions */
template<typename TBoundingBox, typename PointType>
TBoundingBox create(TBoundingBox center, PointType corner) {
    return TBoundingBox(center.cwiseMin(corner),
                        center.cwiseMax(corner));
}
